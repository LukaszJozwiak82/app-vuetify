<template>
  <div class="container">
    <v-app>
      ...
      <div class="pb-4 mb-10 d-flex align-content-space-between flex-wrap flex-md-wrap">
        
        <v-card
          v-for="category in categories"
          v-bind:key="category.id"
          class="mx-auto pa-xs-1 mb-4"
          width="180"
          height="180"
          outlined
          raised
          color="#f2f2f2"
        >
          <a v-bind:href="'#'"><v-card-title>{{ category.name }}</v-card-title></a>
            {{user}}
        </v-card>
      </div>
