...
<div class="container">
    <v-app>
        <!-- <div class="pb-4 d-flex-wrap d-md-flex flex-md-wrap"> -->
        <div class="pb-4 d-flex align-content-space-between flex-wrap flex-md-wrap">
            <v-card class="mx-auto pa-xs-1" width="180" height="180" outlined raised>
                <v-card-title>Karta</v-card-title>
                {{test2}}
                {{user}}
            </v-card>
            <v-card class="pa-5 mx-auto pa-xs-1" width="180" height="180" outlined raised>
                <v-card-title>Karta</v-card-title>
                {{test2}}
                {{user}}
            </v-card>
